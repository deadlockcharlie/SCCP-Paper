...
A sequential type $T = (S,s_0, \Delta)$  is a triple
    ...
    We write $s \xrightarrow{op_1 \dots op_n} s'$ when $\Delta(s, \{op_1 \dots op_n\}) = s'$ and 
\end{definition}
...
Eventual consistency states that all parties apply the same set of operations on a shared object. 
