...
Eventual consistency states that, eventually all parties apply the same set of operations on a shared object.
Eventual consistency is strengthened with guaranteed convergence and termination to define \emph{Strong eventual consistency} \cite{ShapiroPBZ11}. 
