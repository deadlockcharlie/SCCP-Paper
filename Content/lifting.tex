...
%
Going back to the CRDT sequence, removal is implemented by taking the Cartesian product of $(\mathcal{P}, \cup)$ together with a commutative monoid $(D, \land)$ where $D$ is a map from the sequence domain to $\{0,1\}$ and $(D \land D')[x]$ equals $0$ if either $D[x]=0$ or $D'[x]=0$ and $1$ otherwise.
